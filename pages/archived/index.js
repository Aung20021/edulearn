  ...
  const handleDelete = async (courseId) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Refresh the course list or remove it from the state
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              <Link
                href="/courses/new"
                className="inline-flex items-center gap-2 rounded-md border border-green-600 px-4 py-2 text-sm font-medium text-green-600 transition hover:bg-green-50 hover:text-green-700"
              >
                Create Course
              </Link>
            </motion.div>
                ...
                >
                  ...
                  <div className="flex justify-between">
                    <button
                      ...
                      className="text-center block w-full px-4 py-2 text-red-600 hover:bg-gray-100 z-30"
                    >
                      Delete
                    </button>
